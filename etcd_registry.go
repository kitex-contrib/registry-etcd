...
func NewEtcdRegistry(endpoints []string, opts ...Option) (registry.Registry, error) {
	return NewEtcdRegistryWithAuth(endpoints, "", "", opts...)
}

// NewEtcdRegistryWithAuth creates a etcd based registry with given username and password.
func NewEtcdRegistryWithAuth(endpoints []string, username, password string, opts ...Option) (registry.Registry, error) {
	cfg := clientv3.Config{
		Endpoints: endpoints,
		Username:  username,
		Password:  password,
